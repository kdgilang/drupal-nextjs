...
/**
 * Force to use `local` config, unless we are in Acquia Cloud Environment.
 */
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  // Load config split based on Acquia Environment.
...
$settings['hash_salt'] = 'MOdwLugZVtu0vs1JFrFA0nDmuztjbTTjnyBDxr6lenQSXFl7Cqz92nFccxLaEcCJTEIQIN_vng';
